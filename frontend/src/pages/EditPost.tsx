...
import { getCategories, updatePost, uploadImage, getMyPosts } from '../api/client'
...
export default function EditPost() {
  ...
  useEffect(() => {
    ...
    async function loadPost() {
      setLoading(true)
      try {
        // Fetch all creator posts, then find the one with matching id
      ...
      <div className="min-h-screen pt-24 pb-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="animate-pulse space-y-6">
            ...
            <div className="h-80 skeleton rounded"></div>
          </div>
        </div>
      </div>
    )
    ...
    return (
      <div className="min-h-screen pt-24 pb-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-20">
          ...
          <h2 className="text-xl font-bold text-gray-900 mb-2">Failed to load post</h2>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            />
            <p className="mt-1 text-xs text-gray-500">The URL-friendly version of the title.</p>
          </div>
